...
public class LinkIDInRoomMessageInputBoard extends Dialog {

    private ZegoInRoomMessageInput contentView;
    private boolean enableChat = true;

    public LinkIDInRoomMessageInputBoard(@NonNull Context context) {
        super(context);
    }

    public LinkIDInRoomMessageInputBoard(@NonNull Context context, int themeResId) {
