...
public class LanguageText {
    ...
    public LinkIDDialogInfo receivedCoHostRequestDialogInfo = new LinkIDDialogInfo("Co-host request",
        "%s wants to co-host with you.", "Disagree", "Agree");
    public LinkIDDialogInfo receivedCoHostInvitationDialogInfo = new LinkIDDialogInfo("Invitation",
        "The host is inviting you to co-host.", "Disagree", "Agree");
    public LinkIDDialogInfo endConnectionDialogInfo = new LinkIDDialogInfo("End the connection",
        "Do you want to end the cohosting?", "Cancel", "OK");
    public LinkIDDialogInfo stopLiveDialogInfo = new LinkIDDialogInfo("Stop the live",
