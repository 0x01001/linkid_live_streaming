...
public class LanguageTextCHS extends LanguageText {
    ...
    public LanguageTextCHS() {
        ...
        receivedCoHostRequestDialogInfo = new LinkIDDialogInfo("请求连麦", "%s 想与您连麦",
            "不同意", "同意");
        receivedCoHostInvitationDialogInfo = new LinkIDDialogInfo("邀请", "主播邀请您连麦",
            "不同意", "同意");
        endConnectionDialogInfo = new LinkIDDialogInfo("结束连麦", "您确定要结束连麦吗？","取消","确定");
        stopLiveDialogInfo = new LinkIDDialogInfo("停止直播",
            "您确定要停止直播吗？", "取消", "停止直播");
    }
}
