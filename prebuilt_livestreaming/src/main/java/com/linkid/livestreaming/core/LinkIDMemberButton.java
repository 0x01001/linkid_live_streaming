...
public class LinkIDMemberButton extends androidx.appcompat.widget.AppCompatTextView {

    private ZegoUserUpdateListener zegoUserUpdateListener;

    public LinkIDMemberButton(Context context) {
        super(context);
        initView();
    }

    public LinkIDMemberButton(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initView();
    }

    public LinkIDMemberButton(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
