...
public class LinkIDTranslationText {
    ...
    public LinkIDDialogInfo receivedCoHostRequestDialogInfo;
    public LinkIDDialogInfo receivedCoHostInvitationDialogInfo;
    public LinkIDDialogInfo endConnectionDialogInfo;
    public LinkIDDialogInfo stopLiveDialogInfo;
    ...
    public LinkIDTranslationText() {
        languageText = new LanguageTextEnglish();
    }

    public LinkIDTranslationText(ZegoUIKitLanguage language) {
