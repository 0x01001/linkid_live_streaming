...
public class LinkIDEnableChatButton extends androidx.appcompat.widget.AppCompatImageView {
    ...
    public LinkIDEnableChatButton(@NonNull Context context) {
        super(context);
        initView();
    }

    public LinkIDEnableChatButton(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public LinkIDEnableChatButton(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
