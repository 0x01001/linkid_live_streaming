 ...
 * only for local user
 */
public class LinkIDLiveMicrophoneButton extends ZEGOImageButton {

    public LinkIDLiveMicrophoneButton(@NonNull Context context) {
        super(context);
    }

    public LinkIDLiveMicrophoneButton(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public LinkIDLiveMicrophoneButton(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
