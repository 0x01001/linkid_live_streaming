...
public class LinkIDPKAvatarView extends FrameLayout {
    ...
    public LinkIDPKAvatarView(Context context) {
        super(context);
        initView();
    }

    public LinkIDPKAvatarView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }
