...
import com.linkid.livestreaming.databinding.LivestreamingLayoutMemberlistBinding;
                    ...
                    if (isHost) {
                        ...
                        if (isYou) {
                            ...
                            if (isCoHost) {
                                ...
                                boolean isRequested = LinkIDLiveStreamingManager.getInstance()
        ...
        if (memberListItemProvider != null) {
            ...
            binding.liveMemberList.setItemViewProvider(new ZegoMemberListItemViewProvider() {
                ...
                public void onBindView(View view, ZegoUIKitUser uiKitUser, int position) {
                    ...
                    LinkIDAcceptCoHostButton agree = view.findViewById(R.id.live_member_item_agree);
                    ...
                    agree.setRequestCallbackListener(v -> {
                        dismiss();
                        LinkIDLiveStreamingManager.getInstance().removeUserStatusAndCheck(uiKitUser.userID);
                    });
                    LinkIDRefuseCoHostButton disagree = view.findViewById(R.id.live_member_item_disagree);
                    ...
                    if (LinkIDLiveStreamingManager.getInstance().isUserCoHostRequestExisted(uiKitUser.userID)) {
