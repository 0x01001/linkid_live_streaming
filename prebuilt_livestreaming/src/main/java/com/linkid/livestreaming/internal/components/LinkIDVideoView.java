...
public class LinkIDVideoView extends TextureView {

    private String userID;
    private String streamID;

    public LinkIDVideoView(@NonNull Context context) {
        super(context);
    }

    public LinkIDVideoView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public LinkIDVideoView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public LinkIDVideoView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
