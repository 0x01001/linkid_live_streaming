...
import com.linkid.livestreaming.databinding.LivestreamingLayoutPkBinding;
...
public class PKBattleView extends FrameLayout {
    ...
    private LinkIDLiveStreamingPKBattleConfig pkBattleConfig;
    private LinkIDPrebuiltAudioVideoViewConfig prebuiltAudioVideoViewConfig;
    ...
    private void initView() {
        ...
        LinkIDLiveStreamingManager.getInstance().addLiveStreamingListener(new LinkIDLiveStreamingListener() {
            ...
            public void onOtherHostCameraOpen(String userID, boolean open) {
                if (LinkIDLiveStreamingManager.getInstance().isPKUser(userID)) {
                    onPKUserCameraUpdate(userID, open);
                } else if (LinkIDLiveStreamingManager.getInstance().isHost(userID)) {
                ...
                if (LinkIDLiveStreamingManager.getInstance().isCurrentUserHost()) {
                    if (userID.equals(binding.pkOtherVideo.getUserID())) {
                        if (disconnected) {
                            ...
                            if (!LinkIDLiveStreamingManager.getInstance().isAnotherHostMuted()) {
                    ...
                    if (LinkIDLiveStreamingManager.getInstance().isHost(userID)) {
                        if (disconnected) {
                    ...
                    } else if (LinkIDLiveStreamingManager.getInstance().isPKUser(userID)) {
                        if (disconnected) {
    ...
    public void setPKBattleConfig(LinkIDLiveStreamingPKBattleConfig pkBattleConfig) {
        this.pkBattleConfig = pkBattleConfig;
    }

    public void setPrebuiltAudioVideoConfig(LinkIDPrebuiltAudioVideoViewConfig prebuiltAudioVideoViewConfig) {
