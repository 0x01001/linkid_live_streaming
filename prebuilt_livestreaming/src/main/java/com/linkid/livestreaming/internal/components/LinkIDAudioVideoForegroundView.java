...
public class LinkIDAudioVideoForegroundView extends ZegoBaseAudioVideoForegroundView {
    ...
    public LinkIDAudioVideoForegroundView(@NonNull Context context, String userID) {
        super(context, userID);
    }

    public LinkIDAudioVideoForegroundView(@NonNull Context context, @Nullable AttributeSet attrs, String userID) {
