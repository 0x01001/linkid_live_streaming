...
public class LinkIDScreenShareForegroundView extends ZegoBaseAudioVideoForegroundView {
    ...
    public LinkIDScreenShareForegroundView(ViewGroup screenSharingView, String userID) {
